  ...
  <body>
    ...
    <main role="main">
      ...
      <div class="container">
        ...
        <div class="row">
            <?php
		//echo "<form action = see_reviews.php>"
                while ($row = mysqli_fetch_array($movie_query_result)) {
                    ...
                    echo "</div>";
                    echo "<div class='col-md-4 mb-3'>";
                    echo "<p><a class='btn btn-secondary' href='../php/see_reviews.php?pelicula=" . $row['title'] . "' role='button'>Reviews &raquo;</a></p>";
			//php/see_reviews.php?pelicula=Harry Potter
                    echo "</div>";
                    echo "</div>";
                    echo "</div>";
